...
export default function ViewProfile() {
  ...
  useEffect(() => {
    ...
    const fetchData =  () => {
      console.log("entered");
      console.log(email);
      axios.get(`https://8080-bbafeefeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/getProfile/${email}`)
        .then((result) => {
          console.log(result);
          setProfile({...profile,
  ...
  const handleSave = async () => {
    try {
      ...
      console.log(profile)
      axios.put(`https://8080-bbafeefeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/editProfile/${email}`,profile).then((response)=>{
