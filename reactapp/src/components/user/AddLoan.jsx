...
function AddLoan() {
  ...
  const addloan = () => {
    ...
    axios
      .post("https://8080-aaddebfbaaeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/addProfile", formdata2)
      .then(() => {
        console.log("added");
  ...
  const handleapply = (e) => {
    ...
    axios
      .post("https://8080-aaddebfbaaeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/addLoan", formdata)
      .then((result) => {
        if (result.data === "Loan Application Added") {
          console.log(formdata2);
          axios
            .get("https://8080-aaddebfbaaeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/getLoanId")
            .then((res) => {
  ...
  const addDoc = async (e) => {
    ...
    axios
      .post("https://8080-aaddebfbaaeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/addDocuments", formData)
      .then((res) => {
        axios
          .get("https://8080-aaddebfbaaeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/getDocumentId")
          .then((res) => {
