...
export default function GetLoans() {
  ...
  const fetchAppliedLoans = () => {
    axios
      .get('https://8080-bbafeefeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/admin/getAllLoans')
      .then((res) => {
  ...
  const handleReject = (e,loan) => {
    loan.status=2
    console.log(loan);
    axios.put(`https://8080-bbafeefeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/editLoan/${loan.loanId}`, loan).then((res) => {
  ...
  const handleApprove = (e,loan) => {
    loan.status=1
    console.log(loan);
    axios.put(`https://8080-bbafeefeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/editLoan/${loan.loanId}`, loan)
    .then((res) => {
      axios.put(`https://8080-bbafeefeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/admin/generateEmi/${loan.loanId}`).then((res)=>console.log(res))
      window.location.reload(true);
    })
    .catch((err) => console.log(err));
  };
  ...
  useEffect(() => {
    fetch("https://8080-bbafeefeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/admin/getAllLoans", {
      method: "GET",
      headers: {
