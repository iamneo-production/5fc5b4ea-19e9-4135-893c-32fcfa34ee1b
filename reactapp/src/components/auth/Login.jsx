...
export default function Login() {
  ...
  const login = async (e) => {
    ...
    const url1 = 'https://8080-aaddebfbaaeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/login';
    const url2 = 'https://8080-aaddebfbaaeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/admin/login';
