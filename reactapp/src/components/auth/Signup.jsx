...
const handleConfirmPasswordChange = (value) => {
  ...
  const registration = async (e) => {
    ...
    if (userRole === "admin") {
      const url2 = 'https://8080-bbafeefeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/admin/signup';
      ...
      const url1 = 'https://8080-bbafeefeaedabdacfdafeabdcdceeeeaf.project.examly.io/api/user/signup';
